 ...
 */
public class Carcass extends Projectiles{
	
	public Carcass(Screen screen, int ref, TimeManager currentTime, BasicShape shape, Point shooterPosition) {
		super(screen, ref, currentTime, shape, shooterPosition);
		id = 2;
		name = "carcass";
		shapeChangingDist = 42 + (   4*getCurrentTime().getHour() +  2*getCurrentTime().getMinute() + getCurrentTime().getSecond() ) % 42;
